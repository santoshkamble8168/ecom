...
## Purpose
Defines durable engineering expectations for database rules across web, mobile, SaaS, API, microservice, enterprise, AI, e-commerce, and internal-tool projects.
