...
## Purpose
Defines durable engineering expectations for logging rules across web, mobile, SaaS, API, microservice, enterprise, AI, e-commerce, and internal-tool projects.
