...
## Purpose
Defines durable engineering expectations for architecture rules across web, mobile, SaaS, API, microservice, enterprise, AI, e-commerce, and internal-tool projects.
