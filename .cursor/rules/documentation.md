...
## Purpose
Defines durable engineering expectations for documentation rules across web, mobile, SaaS, API, microservice, enterprise, AI, e-commerce, and internal-tool projects.
