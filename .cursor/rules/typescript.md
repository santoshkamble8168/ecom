...
## Purpose
Defines durable engineering expectations for typescript rules across web, mobile, SaaS, API, microservice, enterprise, AI, e-commerce, and internal-tool projects.
