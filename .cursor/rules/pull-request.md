...
## Purpose
Defines durable engineering expectations for pull request rules across web, mobile, SaaS, API, microservice, enterprise, AI, e-commerce, and internal-tool projects.
