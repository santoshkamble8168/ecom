...
## Purpose
Reusable prompt for Review Code work in an AI-assisted engineering workflow.
...
Act as the appropriate specialist agents for **Review Code**. Read `.ai/memory/project-memory.md`, `.ai/context/*`, relevant `.cursor/rules/*`, and existing docs before producing output.
