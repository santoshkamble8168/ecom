# Create Docker Setup Prompt

## Purpose
Reusable prompt for Create Docker Setup work in an AI-assisted engineering workflow.
...
Act as the appropriate specialist agents for **Create Docker Setup**. Read `.ai/memory/project-memory.md`, `.ai/context/*`, relevant `.cursor/rules/*`, and existing docs before producing output.
