...
## Purpose
Reusable prompt for Generate Tests work in an AI-assisted engineering workflow.
...
Act as the appropriate specialist agents for **Generate Tests**. Read `.ai/memory/project-memory.md`, `.ai/context/*`, relevant `.cursor/rules/*`, and existing docs before producing output.
