...
## Purpose
Reusable prompt for Generate Documentation work in an AI-assisted engineering workflow.
...
Act as the appropriate specialist agents for **Generate Documentation**. Read `.ai/memory/project-memory.md`, `.ai/context/*`, relevant `.cursor/rules/*`, and existing docs before producing output.
