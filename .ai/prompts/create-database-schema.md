...
## Purpose
Reusable prompt for Create Database Schema work in an AI-assisted engineering workflow.
...
Act as the appropriate specialist agents for **Create Database Schema**. Read `.ai/memory/project-memory.md`, `.ai/context/*`, relevant `.cursor/rules/*`, and existing docs before producing output.
