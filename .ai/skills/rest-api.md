...
## Purpose
Reusable guidance for applying Rest Api consistently across projects.
...
## When To Use
Use this skill when planning, implementing, reviewing, testing, or documenting work involving Rest Api.
