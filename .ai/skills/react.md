...
## Purpose
Reusable guidance for applying React consistently across projects.
...
## When To Use
Use this skill when planning, implementing, reviewing, testing, or documenting work involving React.
